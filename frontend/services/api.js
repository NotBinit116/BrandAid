...
export const authorService = {
  getFlagged: (brand_id)          => api.get(`/authors/${brand_id}/flagged`),
  getAll:     (brand_id)          => api.get(`/authors/${brand_id}/all`),
  unflag:     (brand_id, flag_id) => api.post(`/authors/${brand_id}/unflag/${flag_id}`),
}
