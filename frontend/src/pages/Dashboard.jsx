      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
        ...
        <div className="flex items-center justify-between flex-wrap gap-3 animate-fade-in">
          <div>
            ...
            <p className="text-sm text-slate-500 mt-0.5">Welcome back, <span className="font-semibold text-slate-700 capitalize">{user?.email?.split('@')[0]}</span></p>
          </div>
        ...
        {loadingBrands && (
          <div className="flex items-center justify-center py-20">
            <svg className="animate-spin w-8 h-8 text-brand-500" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="3" strokeOpacity="0.3"/><path d="M12 2a10 10 0 0 1 10 10" stroke="currentColor" strokeWidth="3" strokeLinecap="round"/></svg>
          </div>
        )}
          ...
          <>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 animate-fade-in">
                ...
                <div className="card flex flex-col justify-center gap-3">
                  ...
                  <div className="w-full bg-slate-100 rounded-full h-2.5">
                    <div className={`h-2.5 rounded-full ${score >= 60 ? 'bg-emerald-400' : score >= 40 ? 'bg-amber-400' : 'bg-red-400'}`} style={{ width: `${score}%` }} />
                  </div>
            ...
            <div className="flex items-center gap-2 -mt-2">
              <span className="text-sm text-slate-500">
                Showing <span className="font-semibold text-slate-700">{posts.length}</span> mentions for <span className="font-semibold text-slate-700">{activeBrand.brand_name}</span>
              </span>
              {loadingPosts && <svg className="animate-spin w-4 h-4 text-brand-500" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="3" strokeOpacity="0.3"/><path d="M12 2a10 10 0 0 1 10 10" stroke="currentColor" strokeWidth="3" strokeLinecap="round"/></svg>}
            </div>
