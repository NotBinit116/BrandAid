const PLATFORM_ICONS = {
  Twitter:      <svg width="13" height="13" viewBox="0 0 13 13" fill="currentColor"><path d=".5 1h3.5l2.5 3.5L9 1h3L8 6.5 12.5 12H9L6.5 8.5 4 12H1L5.5 6.5.5 1z"/></svg>,
...
export default function PostCard({ post, onClick, compact = false, flaggedAuthors = [] }) {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 flex-wrap">
        ...
        {!compact && isFlaggedAuthor && (
          <span className="inline-flex items-center gap-1 text-xs font-semibold bg-orange-50 text-orange-600 border border-orange-200 px-2 py-0.5 rounded-full">
            🚩 Flagged Author
          </span>
        )}
